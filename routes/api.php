...
Route::get('/donasiLaporanPerKegiatan/{id}','DonasiController@laporanPerKegiatan');
Route::get('/donasiLaporanJenisDonasiSemuaKegiatan','DonasiController@laporanJenisDonasiSemuaKegiatan');
Route::get('/donasiLaporanJenisDonasiPerKegiatan/{id_kegiatan}','DonasiController@laporanJenisDonasiPerKegiatan');
